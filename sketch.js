...
function draw(){
  ...
  text("- para solicitar datos del satélite", 5,190)
  text("Presiona las teclas de  Derecha o Izquierda", 5,210)
  text("- para transferir datos del satélite", 5,230)
  ...
  if(keyDown("R")){
    text("Solicitando datos del satélite", 380,300)
  }
  if(keyDown("LEFT_ARROW")){
    text("Transfiriendo datos a la estación base Izquierda", 10,300)
  }
  if(keyDown("RIGHT_ARROW")){
    text("Transfiriendo datos a la estación base Derecha", 360,300)
  }
  drawSprites();
}
